...
import com.bmpl.talentfinder.users.listeners.SessionCheckListener;

/**
 * Servlet implementation class WelcomeServlet
 */
//@WebServlet("/welcome.talent")
@WebServlet(urlPatterns="/welcome.talent",loadOnStartup=1)
...
//		else{
		...
		String logout = "<form action='"+logOutURL+"'><button type='submit'>Logout</button></form>";
		String welcomeMessage = "<br><h2>Welcome Bill is "+bill+" Branch "+branch+" TollFreeNo is "+phoneNo+" EMAIL "+email
